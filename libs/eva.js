...
function convNE(opt, classGen) {
    ...
    this.stopEvolve = () => {
        for (let i = 0; i < this.trainer.chromosomes.length; i++) {
            this.trainer.chromosomes[i].fitness = this.genes[i].brain.score;
        }
    ...
    this.sort = () => {
        this.genes.sort((a, b) => b.brain.score - a.brain.score);
        return this.genes[0];
    }
